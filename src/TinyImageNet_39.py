...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        conv3out = (self.lrelu(self.bn(self.conv3(x)))) # * prob_weight[2]
        conv2out = (self.lrelu(self.bn(self.conv2(x)))) # * prob_weight[1]
        conv1out = (self.lrelu(self.bn(self.conv1(x)))) # * prob_weight[0]
...
class TinyImagenetNet(nn.Module):
    def __init__(self, device):
        ...
        self.conv1 = Block(3, 8, device)
        self.conv2 = Block(24, 8, device)
        self.conv3 = Block(24, 24, device)
        self.conv4 = Block(72, 24, device)
        self.conv5 = Block(72, 72, device)
        # self.conv6 = Block(216, 72, device)
